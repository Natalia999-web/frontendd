            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {(() => {
                ...
                if (ep === "pagado_completo" || (!ep && totalPagado >= totalPedido && totalPedido > 0 && totalPagado > 0)) {
                  ...
                  estadoLabel = "Anticipo";         estadoColor = "#e65100"; estadoBg = "#fff8e1"; estadoBorder = "#ffe082"; EstadoIcon = AlertCircle;
                    ...
                    <div style={{ background: estadoBg, border: `1.5px solid ${estadoBorder}`, borderRadius: 14, padding: "16px 18px", display: "flex", flexDirection: "column", gap: 12 }}>
                      ...
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px 16px" }}>
                        ...
                        <div className="ver-ped-field">
                          ...
                          <span className="ver-ped-field__value" style={{display:"inline-flex",alignItems:"center",gap:5}}>{esTransferencia ? <><Building2 size={14} /> Transferencia</> : <><Banknote size={14} /> Efectivo</>}</span>
                        </div>
                        {modalidad && (
                          <div className="ver-ped-field">
